...
It uses the [WorkFlow Runs API](https://docs.github.com/en/rest/actions/workflow-runs#about-the-workflow-runs-api) allowing `delete` operations by using the `/repos/{owner}/{repo}/actions/runs` endpoint.
